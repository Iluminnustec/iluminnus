    ...
    <form action={formAction} className="mt-6 max-w-lg space-y-6">
      <fieldset className="space-y-4">
        ...
        {indicadores.length > 0 && (
          <div>
            <label htmlFor="indicadorId" className={labelClass}>
              Indicado por
            </label>
            <select id="indicadorId" name="indicadorId" className={inputClass} defaultValue="">
            ...
            <p className="mt-1 text-xs text-slate-500">
              Se veio por indicação, o indicador passa a receber comissão sobre os pagamentos
              dessa empresa.
            </p>
          </div>
        )}
