...
import { alterarSenha, type SenhaState } from "@/app/painel/senha/actions";
...
export default function AlterarSenhaAdminPage() {
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-slate-500">Troque a senha da sua conta na Iluminnus.</p>
      ...
      <form action={formAction} className="mt-6 max-w-sm space-y-4">
        <div>
          ...
          <PasswordInput
            ...
            name="senhaAtual"
            required
            className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm focus:border-iluminnus-navy focus:outline-none"
          />
        </div>
        ...
        {state.success && <p className="text-sm text-green-700">Senha alterada com sucesso.</p>}
